...
async def get_thumb(videoid):
    ...
    try:
        ...
        try:
            font_title = ImageFont.truetype("SONALI_MUSIC/assets/font.ttf", 45)
            font_details = ImageFont.truetype("SONALI_MUSIC/assets/font2.ttf", 30)
        ...
        stats_text = f"YouTube : {views} | Time : {duration} | Player : @SukkuMusicBot"
